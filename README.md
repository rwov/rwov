...
contact for web/ios apps [https://dxu.one](https://dxu.one) | building in private @XbuildApp @InsightfullApp | published ios apps [Insightfull (being reworked)](https://app.insightfull.app) [Mentio](https://mentio.insightfull.app) | couple OSS projects [HTTPKit](https://github.com/rwov/HTTPKit) [opsh](https://github.com/rwov/opsh)
